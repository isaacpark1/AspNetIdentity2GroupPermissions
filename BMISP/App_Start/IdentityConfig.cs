...
namespace BMISP.Models
{
    ...
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext> 
    {
        ...
        public static void InitializeIdentityForEF(ApplicationDbContext db) {
            ...
            const string fname = "Super";
            const string lname = "User";
            const string usertype = "Z";
            ...
            if (user == null) {
                user = new ApplicationUser { UserName = name, Email = name, EmailConfirmed = true, FName = fname, LName = lname, UserType = usertype  };
